    ...
    <body style="background-color:salmon;">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="https://discord.gg/H9Ez4UF2"><b>DISCORD</b></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="/program/aplication/views/auth/login.php"><b>LOGIN</b></a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container">
            <div class="container" style="background-color:yellow;border-radius:15px;">
                <div class="h-100 p-5">
                    <h2>
                        <marquee><a class="warnabiru">SELAMAT DATANG</a> DI WEBSITE <a class="warnalain">KOTAK CRAFT! <svg class="sabol" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 284 413">
                                    <defs>
                                        <path id="a" d="M.088.382h21.71v33.856H.089z"></path>
                                        <path id="c" d="M0 .728h21.249v32.847H0z"></path>
                                        <path id="e" d="M.81.289h28.175V44.9H.811z"></path>
                                        <path id="g" d="M.91.684h112.876V22H.91z"></path>
                                    </defs>
                                    <g fill="none" fill-rule="evenodd">
                                        ...
                                        <g fill="#1E1E4B">
                                            <path d="M20.58 168.03a3.986 3.986 0 0 0-.41 4.753c24.66 40.16 63.037 38.787 64.659 38.708a3.933 3.933 0 0 0 3.747-4.19 4.082 4.082 0 0 0-4.248-3.805c-.469.065-35.3 1.075-57.34-34.82-1.165-1.897-3.634-2.515-5.517-1.381a3.9 3.9 0 0 0-.892.735"> </path>
                    ...
                    <p>
                    <h5 class="basar">KOTAK CRAFT SERVER MINECRAFT<br>MENYEDIAKAN RANK GAME MINECRAFT UNTUK SERVER KOTAK-CRAFT!</h5><br>
                    <h5>ANDA JUGA BISA MENDAPATKAN RANK MENGGUNAKAN XP! DAN MINIMAL XP 200.000 UNTUK MENDAPATKAN RANK!</h5>
                    </p>
